...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2iB.pack(_x.action_result.result.status, _x.action_result.result.freespace, _x.action_result.result.motionActive))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.status, _x.action_result.result.freespace, _x.action_result.result.motionActive,) = _struct_2iB.unpack(str[start:end])
