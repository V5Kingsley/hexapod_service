...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4i().pack(_x.MODE, _x.SIMPLEMOTION_MODE, _x.MAXPOINTS, _x.LEG_INDEX))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.MODE, _x.SIMPLEMOTION_MODE, _x.MAXPOINTS, _x.LEG_INDEX,) = _get_struct_4i().unpack(str[start:end])
      start = end
      end += 4
