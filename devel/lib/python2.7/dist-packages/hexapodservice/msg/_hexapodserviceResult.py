...
class hexapodserviceResult(genpy.Message):
  _md5sum = "84ae386391a6712ba3f1d0cdfd23bad0"
...
string result
"""
  __slots__ = ['status','freespace','motionActive','result']
  _slot_types = ['int32','int32','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       status,freespace,motionActive,result
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2iB().pack(_x.status, _x.freespace, _x.motionActive))
      _x = self.result
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.status, _x.freespace, _x.motionActive,) = _get_struct_2iB().unpack(str[start:end])
