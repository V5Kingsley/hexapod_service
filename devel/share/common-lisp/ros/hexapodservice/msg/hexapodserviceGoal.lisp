...
(cl:defmethod MAXPOINTS-val ((m <hexapodserviceGoal>))
...
(cl:ensure-generic-function 'LEG_INDEX-val :lambda-list '(m))
(cl:defmethod LEG_INDEX-val ((m <hexapodserviceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hexapodservice-msg:LEG_INDEX-val is deprecated.  Use hexapodservice-msg:LEG_INDEX instead.")
  (LEG_INDEX m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <hexapodserviceGoal>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'LEG_INDEX)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <hexapodserviceGoal>) istream)
  "Deserializes a message object of type '<hexapodserviceGoal>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'LEG_INDEX) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<hexapodserviceGoal>)))
  ...
  "31dfab14f36d4b9186c0a13e789e9115")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'hexapodserviceGoal)))
  "Returns md5sum for a message object of type 'hexapodserviceGoal"
  "31dfab14f36d4b9186c0a13e789e9115")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<hexapodserviceGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%int32 MODE ~%int32 SIMPLEMOTION_MODE~%int32 MAXPOINTS~%int32 LEG_INDEX~%hexapodservice/legjoints ONELEG~%hexapodservice/legs ALLLEGS~%~%================================================================================~%MSG: hexapodservice/legjoints~%int64[] coxa~%int64[] femur~%int64[] tibia~%int64[] tarsus~%~%================================================================================~%MSG: hexapodservice/legs~%hexapodservice/legjoints[6] leg~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'hexapodserviceGoal)))
  "Returns full string definition for message of type 'hexapodserviceGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%int32 MODE ~%int32 SIMPLEMOTION_MODE~%int32 MAXPOINTS~%int32 LEG_INDEX~%hexapodservice/legjoints ONELEG~%hexapodservice/legs ALLLEGS~%~%================================================================================~%MSG: hexapodservice/legjoints~%int64[] coxa~%int64[] femur~%int64[] tibia~%int64[] tarsus~%~%================================================================================~%MSG: hexapodservice/legs~%hexapodservice/legjoints[6] leg~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <hexapodserviceGoal>))
  ...
  (cl:list 'hexapodserviceGoal
    ...
    (cl:cons ':LEG_INDEX (LEG_INDEX msg))
