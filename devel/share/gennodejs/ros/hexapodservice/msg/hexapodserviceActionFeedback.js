...
class hexapodserviceActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new hexapodserviceFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = hexapodserviceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new hexapodserviceActionFeedback(null);
    ...
    data.feedback = hexapodserviceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '993c5aadbec3024b72508dc7b163c37f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new hexapodserviceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = hexapodserviceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new hexapodserviceFeedback()
    }
...
module.exports = hexapodserviceActionFeedback;
