...
static bool motionActive;
//客户端
actionlib::SimpleActionClient<hexapodservice::hexapodserviceAction> hexapodClient("hexapod_sm_service", true);
hexapodservice::hexapodserviceGoal legGoal;
hexapodservice::hexapodserviceGoal maxpointsGoal;

void finalLegs_set(hexapod_msgs::LegsJoints &finalLegs)
{
...
void maxpointsRequest()
{
  ...
  hexapodClient.sendGoal(maxpointsGoal, maxpoint_doneCb);
...
int main(int argc, char **argv)
{
  ...
  hexapodClient.sendGoal(legGoal, maxpoint_doneCb);
