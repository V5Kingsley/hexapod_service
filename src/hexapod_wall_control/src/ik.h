...
public:
  IK(void);
  virtual void calculateIK(const hexapod_msgs::FeetPositions initFeet, const hexapod_msgs::FeetPositions &feet, hexapod_msgs::LegsJoints *legs) = 0;
  virtual ~IK(){}
...
public:
  Hexapod_IK();
  virtual void calculateIK(const hexapod_msgs::FeetPositions initFeet, const hexapod_msgs::FeetPositions &feet, hexapod_msgs::LegsJoints *legs);
  virtual ~Hexapod_IK(){}
};
