...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    control.feedDrives(control.gait.start_cycle, control.gait.cycle_period_, control.gait.is_travelling_, control.gait.cycle_leg_number_, control.gait.smooth_base_, control.gait.hexapod_stop_flag);
    loop_rate.sleep();
