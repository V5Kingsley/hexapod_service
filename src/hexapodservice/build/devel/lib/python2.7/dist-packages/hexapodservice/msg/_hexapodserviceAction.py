...
class hexapodserviceAction(genpy.Message):
  _md5sum = "1b7d056ea35d7e110b87665b6ae5d97c"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4i.pack(_x.action_goal.goal.MODE, _x.action_goal.goal.SIMPLEMOTION_MODE, _x.action_goal.goal.MAXPOINTS, _x.action_goal.goal.LEG_INDEX))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4d.pack(_x.action_result.result.ONELEG_fdbk.coxa, _x.action_result.result.ONELEG_fdbk.femur, _x.action_result.result.ONELEG_fdbk.tibia, _x.action_result.result.ONELEG_fdbk.tarsus))
      for val1 in self.action_result.result.ALLLEGS_fdbk.leg:
        _x = val1
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i2qiB3I.pack(_x.action_result.result.status, _x.action_result.result.freespace, _x.action_result.result.minimumBufferFreeBytes, _x.action_result.result.maxpoints, _x.action_result.result.motionActive, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4d.pack(_x.action_feedback.feedback.ONELEG_fdbk.coxa, _x.action_feedback.feedback.ONELEG_fdbk.femur, _x.action_feedback.feedback.ONELEG_fdbk.tibia, _x.action_feedback.feedback.ONELEG_fdbk.tarsus))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.MODE, _x.action_goal.goal.SIMPLEMOTION_MODE, _x.action_goal.goal.MAXPOINTS, _x.action_goal.goal.LEG_INDEX,) = _struct_4i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sq'%length
      ...
      (_x.action_result.result.ONELEG_fdbk.coxa, _x.action_result.result.ONELEG_fdbk.femur, _x.action_result.result.ONELEG_fdbk.tibia, _x.action_result.result.ONELEG_fdbk.tarsus,) = _struct_4d.unpack(str[start:end])
      self.action_result.result.ALLLEGS_fdbk.leg = []
      for i in range(0, 6):
        ...
        self.action_result.result.ALLLEGS_fdbk.leg.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.status, _x.action_result.result.freespace, _x.action_result.result.minimumBufferFreeBytes, _x.action_result.result.maxpoints, _x.action_result.result.motionActive, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i2qiB3I.unpack(str[start:end])
      ...
      (_x.action_feedback.feedback.ONELEG_fdbk.coxa, _x.action_feedback.feedback.ONELEG_fdbk.femur, _x.action_feedback.feedback.ONELEG_fdbk.tibia, _x.action_feedback.feedback.ONELEG_fdbk.tarsus,) = _struct_4d.unpack(str[start:end])
...
_struct_i2qiB3I = struct.Struct("<i2qiB3I")
