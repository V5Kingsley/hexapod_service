...
"""autogenerated by genpy from hexapodservice/hexapodserviceActionFeedback.msg. Do not edit."""
import sys
...
class hexapodserviceActionFeedback(genpy.Message):
  _md5sum = "f70937454f4ad68d935a46c7f81cef80"
  _type = "hexapodservice/hexapodserviceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hexapodservice/hexapodserviceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(hexapodserviceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hexapodservice.msg.hexapodserviceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hexapodservice.msg.hexapodserviceFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4d.pack(_x.feedback.ONELEG_fdbk.coxa, _x.feedback.ONELEG_fdbk.femur, _x.feedback.ONELEG_fdbk.tibia, _x.feedback.ONELEG_fdbk.tarsus))
      for val1 in self.feedback.ALLLEGS_fdbk.leg:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.ONELEG_fdbk.coxa, _x.feedback.ONELEG_fdbk.femur, _x.feedback.ONELEG_fdbk.tibia, _x.feedback.ONELEG_fdbk.tarsus,) = _struct_4d.unpack(str[start:end])
      self.feedback.ALLLEGS_fdbk.leg = []
      for i in range(0, 6):
        ...
        self.feedback.ALLLEGS_fdbk.leg.append(val1)
      return self
