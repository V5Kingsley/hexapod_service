...
class hexapodserviceFeedback(genpy.Message):
  _md5sum = "b5907e585dac45559e0c76e6e267762d"
...
"""
  __slots__ = ['ONELEG_fdbk','ALLLEGS_fdbk']
  _slot_types = ['hexapodservice/legjoint','hexapodservice/leg']
