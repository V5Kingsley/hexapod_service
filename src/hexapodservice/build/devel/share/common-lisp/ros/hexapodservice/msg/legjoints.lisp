...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <legjoints>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'coxa))))
  ...
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
   ...
   (cl:slot-value msg 'coxa))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'femur))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
   ...
   (cl:slot-value msg 'femur))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'tibia))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
   ...
   (cl:slot-value msg 'tibia))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'tarsus))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <legjoints>) istream)
  ...
  (cl:setf (cl:slot-value msg 'coxa) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'coxa)))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'femur) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'femur)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'tibia) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'tibia)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'tarsus) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'tarsus)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<legjoints>)))
  ...
  "30491f146cc62d519f29e03cbd6340f7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'legjoints)))
  "Returns md5sum for a message object of type 'legjoints"
  "30491f146cc62d519f29e03cbd6340f7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<legjoints>)))
  ...
  (cl:format cl:nil "int64[] coxa~%int64[] femur~%int64[] tibia~%int64[] tarsus~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'legjoints)))
  "Returns full string definition for message of type 'legjoints"
  (cl:format cl:nil "int64[] coxa~%int64[] femur~%int64[] tibia~%int64[] tarsus~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <legjoints>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'coxa) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'femur) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'tibia) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'tarsus) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
